...
//		String cs = "SELECT * FROM corsostudi WHERE id=?";
		...
		String cs = "SELECT distinct corsostudi.id,corsostudi.nome,codice,abbreviazione,durataanni,sede,corsostudi.informativa, dipart.nome as dipart " +
		...
		try {
			...
			if (id.equals("")) {      //recupero e visualizzo tutti i corsi di studio disponibili
				...
				*/
				...
				out.println("<li><b>Dipartimento</b>:" + rs.getString("Dipart") + "</li>");
